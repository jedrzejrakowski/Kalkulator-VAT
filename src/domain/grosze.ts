 ...
 * dziesiętnych: 2,135 leży w pamięci jako 2,13499999…, więc zwykłe
 * zaokrąglenie daje 2,13 zamiast 2,14. Poprzednia wersja próbowała to łatać,
 * dodając `Number.EPSILON`, ale ta poprawka ma sens tylko przy liczbach
 * bliskich jedności — przy kwotach faktur jest mniejsza niż dokładność samej
 * liczby i znika bez śladu. Przy odliczeniu 50% skutkiem było zaniżenie
 * kwoty o grosz mniej więcej na co trzydziestej fakturze.
 *
